      ...
      <div className={styles.container}>
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerSection}>
            <h4>ჩვენს შესახებ</h4>
            <p>
              აქ შეგიძლიათ დაწეროთ მოკლე ტექსტი თქვენი კომპანიის ან პროექტის შესახებ,
              რათა მომხმარებელმა იცოდეს, რას წარმოადგენთ.
            </p>
          </div>
          ...
          <div className={styles.footerSection}>
            ...
            <ul>
              ...
              <li><a href="/portfolio">პორტფოლიო</a></li>
        ...
        <div className={styles.footerBottom}>
          <p>&copy; {currentYear} Copyright of NZD</p>
        </div>
      </div>
    </footer>
  );
